#include "GLGraphicsDevice_ps.hpp"
#include <ciri/wnd/Window.hpp>

namespace ciri {
	GLGraphicsDevice_ps::GLGraphicsDevice_ps()
		: _hdc(0), _hglrc(0) {
	}
	...
	bool GLGraphicsDevice_ps::create( Window* window ) {
	...
	void GLGraphicsDevice_ps::destroy() {
	...
	void GLGraphicsDevice_ps::present() {
		glClearColor(0.39f, 0.58f, 0.93f, 1.0f);
		glClear(GL_COLOR_BUFFER_BIT);
		SwapBuffers(_hdc);
	}

	bool GLGraphicsDevice_ps::configureGl( HWND hwnd ) {
