#ifndef __ClipPlane__
#define __ClipPlane__
...
struct ClipPlane {
	...
	ClipPlane( const cc::Vec3f& inNormal, const float inConstant )
	...
	static ClipPlane constructFromPointNormal( const cc::Vec3f& point, const cc::Vec3f& normal ) {
		ClipPlane result;
	...
	static bool fitPointsToPlane( const std::vector<cc::Vec3f>& points, float& residualError, ClipPlane& outPlane );
	static bool fitPointsToPlane( const std::vector<cc::Vec4f>& points, cc::Vec3f& basis1, cc::Vec3f& basis2, float& normalEigenValue, float& residualError, ClipPlane& outPlane );
